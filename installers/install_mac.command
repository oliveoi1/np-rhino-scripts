...
echo ""
echo "In Rhino, create an alias named NP with this command:"
echo "${ALIAS_CMD}"
echo ""
echo "${ALIAS_CMD}" | pbcopy 2>/dev/null && echo "(Command copied to clipboard.)" || true
echo ""
echo "Then type NP in Rhino and press Enter."
